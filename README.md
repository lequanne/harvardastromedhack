...
Daily horoscopes for your home appliances, generated by COSMO-TRON 3000. Uses real moon phase math, real local weather, and Claude to produce completely sincere astrological readings for your fridge, washing machine, oven, and whoever else is acting up.
...
```bash
git clone https://github.com/YOUR_USERNAME/appliance-horoscope
...
- **Horoscopes** — Claude (`claude-sonnet-4-20250514`) plays COSMO-TRON 3000, a fully sincere appliance astrologer, cross-referencing your appliance's recent behaviour with celestial conditions.
